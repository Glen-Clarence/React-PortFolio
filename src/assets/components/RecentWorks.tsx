    ...
    <>
      ...
      <div className="container flex gap-10 justify-between">
        <Heading
          size="text-base"
          bold={false}
          className=" mt-14 md:mt-36 md:leading-[2.5rem]  md:text-2xl font-rubik tracking-wider text-slate-600 leading-subHeading"
        >
          <span>
            I am dedicated to delivering the best possible user experience
            through my front-end design and development work.{" "}
          </span>
        </Heading>
      </div>
